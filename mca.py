...
# Threshold-based attention mechanism
class Sparse_En_MHAtt(nn.Module):
    def __init__(self, __C):
...
class Sparse_De_MHAtt(nn.Module):
    def __init__(self, __C):
    ...
    def att(self, value, key, query, mask):
        ...
        att_map = F.softmax(scores, dim=-1)
# Sparse
        sparse_map = torch.full_like(scores, 0.1)
...
class SGA(nn.Module):
    def __init__(self, __C):
        ...
        self.mhatt1 = Sparse_De_MHAtt(__C)
...
# SVAVQAN layers cascaded by Encoder-Decoder
